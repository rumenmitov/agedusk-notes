banner:: https://zsorohome.files.wordpress.com/2020/11/wizard-duel-art.jpg?w=1000
icon:: 󱑷
	...
	- ## Level 1
		...
		- **Magic Missile**
		  collapsed:: true
			...
			- *At Higher Levels.* When you cast this spell 
			  using a spell slot of 2nd level or higher, the spell creates one more 
		...
		- **Disguise Self**
		  collapsed:: true
			...
			- The changes wrought by this spell fail to hold up to physical 
			  ...
			  touch you would bump into you while it was seemingly still in midair. To
		...
		- **Color Spray**
		  collapsed:: true
			...
			- Starting with the creature that has the lowest current hit points, 
			  each creature affected by this spell is blinded until the end of your 
			  next turn. Subtract each creature’s hit points from the total before 
			  moving on to the creature with the next lowest hit points. A creature’s 
			  hit points must be equal to or less than the remaining total for the 
		...
		- **False Life**
		  collapsed:: true
			...
			- *At Higher Levels.* When you cast this spell 
			  using a spell slot of 2nd level or higher, you gain 5 additional 
		...
		- **Alarm**
		  collapsed:: true
			...
			- A mental alarm alerts you with a ping in your mind if you are within 1
			  mile of the warded area. This ping awakens you if you are sleeping. An 
			  audible alarm produces the sound of a hand bell for 10 seconds within 60
			  feet.
	- ## Level 2
		- slots_available::  2
		- **Suggestion**
		...
		- **Hold Person**
		  collapsed:: true
			...
			- *At Higher Levels.* When you cast this spell 
			  using a spell slot of 3rd level or higher, you can target one additional
			  humanoid for each slot level above 2nd. The humanoids must be within 30
